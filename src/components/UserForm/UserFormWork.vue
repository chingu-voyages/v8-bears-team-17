  ...
  <v-flex xs12 sm6 md4>
    <v-card class="ma-2 pa-2 card">
      ...
      >
          ...
          <v-card-title class="subheading">
            ...
            <span>
              <v-btn
                ...
                color="#24a4b3"
                @click="addItem(
            $event, {highlight:''} ,info[work_index].highlights
            )"
              >
                Add highlight
          ...
          <v-list>
            ...
            >
              ...
              <v-btn
                ...
                small
                @click="removeItem(
                  $event,highlight_index, info[work_index].highlights)"
              >
        ...
        <v-layout>
          <v-spacer></v-spacer>
          <v-btn dark color="#24a4b3" @click="removeItem($event,work_index, info)">
            Delete
